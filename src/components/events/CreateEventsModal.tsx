...
interface CreateEvents {
  isOpen?: boolean;
  onClose?: () => void;
  onSubmit?: (title: string, location:string, description: string, endDate: string, startDate: string, image: string) => void;
}
...
const CreateEvents: React.FC<CreateEvents> = ({ isOpen, onClose, onSubmit }) => {
  ...
  const handleCreateStartDateChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setCreateStartDate(event.target.value);
  };


  const handleCreateEndDateChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    onSubmit && onSubmit(CreateTitle, CreateLocation,CreateDescription, CreateEndDate, CreateStartDate, CreateImage);
    setCreateTitle('');
    setCreateStartDate('');
    setCreateEndDate('');
    setCreateLocation('');
          ...
          <div className='flex flex-col w-full'>
            ...
            <div className='flex flex-col w-full'>
              ...
              <div className='flex justify-between'>
                ...
                <input onChange={handleCreateTitleChange} value={CreateTitle} type="text" id="event_title" className='mr-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder="Title" />

                <select onChange={handleCreateLocation} value={CreateLocation} id="countries" className='mr-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'>
            ...
            <div className='flex justify-between mt-4'>
              ...
              <input onChange={handleCreateStartDateChange} value={CreateStartDate} type="date" id="startDate" className='mr-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
              </div>
              ...
              <input onChange={handleCreateEndDateChange} value={CreateEndDate} type="date" id="endDate" className='mr-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
              </div>
