...
interface CreateEvents {
  isOpen?: boolean;
  onClose?: () => void;
  onSubmit?: (title: string, location: string, description: string, endDate: string, startDate: string, image: string, url: string) => void;
}


const CreateEvents: FC<CreateEvents> = ({ isOpen, onClose, onSubmit }) => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    onSubmit && onSubmit(CreateTitle, CreateLocation, CreateDescription, CreateEndDate, CreateStartDate, CreateImage, CreateURL);
    setCreateTitle('');
    setCreateStartDate('');
    setCreateEndDate('');
    setCreateLocation('');
