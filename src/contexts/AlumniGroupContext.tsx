...
export const AlumniGroupContext = createContext<AlumniGroupContextType | null>(null);
...
export const AlumniGroupProvider: FC<IAlumniGroup> = ({children}) => {
    ...
    const updateAlumniGroup = async (alumniGroupToUpdate: IAlumniGroup, id: number) => {
    ...
    return (
        <>
            <AlumniGroupContext.Provider value={{alumniGroups, updateAlumniGroup, postAlumniGroup, deleteAlumniGroup}}>
                {children}
